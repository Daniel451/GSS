...
Eigenschaften wird also als größtmöglich angenommen, jedoch in Abhängigkeit der maximalen Schutzmechanismen des Systems. Das Angreifermodell beschreibt also die Situation eines starken Angreifers, bei
dem die implementierten Schutzmechanismen aber noch Wirkung zeigen. Dies dient zur Charakterisierung der möglichen Angriffsszenarios sowie als auch der Beschreibung der Schutzmechanismen.
Die Aufstellung eines Angreifermodells macht insofern Sinn, als damit die aktuelle Sicherheitsarchitektur analysiert werden kann. Nach der Aufstellung ist ersichtlich, welche Angriffsszenarien maximal abgewehrt
